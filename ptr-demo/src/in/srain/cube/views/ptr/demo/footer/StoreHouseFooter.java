package in.srain.cube.views.ptr.demo.footer;
...
import in.srain.cube.views.ptr.demo.header.StoreHouseBarItem;
import in.srain.cube.views.ptr.demo.header.StoreHousePath;
...
public class StoreHouseFooter extends View implements PtrUIFooter {
    ...
    public StoreHouseFooter(Context context) {
        super(context);
        initView();
    }

    public StoreHouseFooter(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public StoreHouseFooter(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public StoreHouseFooter setLineWidth(int width) {
        mLineWidth = width;
    ...
    public StoreHouseFooter setTextColor(int color) {
        mTextColor = color;
        for (int i = 0; i < mItemList.size(); i++) {
    ...
    public StoreHouseFooter setDropHeight(int height) {
        mDropHeight = height;
        return this;
    }
